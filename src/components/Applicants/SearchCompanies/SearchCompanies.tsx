  ...
  useEffect(() => {
    async function getCompanies() {
      try {
        ...
        if (params.length > 0) {
          url = `/companies/filter?${params.join('&')}`
        }
        ...
        <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 text-sm">
              ...
              <span className="text-gray-700 cursor-pointer hover:text-blue-600" onClick={() => setSearchName("Facebook")}>Facebook,</span>
              <span className="text-gray-700 cursor-pointer hover:text-blue-600" onClick={() => setSearchName("Twitter")}>Twitter,</span>
              <span className="text-gray-700 cursor-pointer hover:text-blue-600" onClick={() => setSearchName("Apple")}>Apple,</span>
              <span className="text-gray-700 cursor-pointer hover:text-blue-600" onClick={() => setSearchName("Microsoft")}>Microsoft</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-white p-4 rounded-lg border mb-4">
              ...
              {['Technology', 'E-commerce', 'Entertainment', 'Travel', 'Transportation', 'Finance', 'Healthcare'].map((ind) => (
                <label key={ind} className="flex items-center mb-2 cursor-pointer">
                  <input
                    ...
                    className="mr-2"
                  />
                  <span className={industry === ind ? 'text-blue-600 font-semibold' : ''}>
                    {ind}
                  </span>
                </label>
              ))}
            ...
            <div className="bg-white p-4 rounded-lg border mb-4">
              ...
              {[
                ...
                <label key={size.value} className="flex items-center mb-2 cursor-pointer">
                  <input
                    type="checkbox"
                    ...
                    className="mr-2"
                  />
                  <span className={companySize === size.value ? 'text-blue-600 font-semibold' : ''}>
                    {size.label}
                  </span>
                </label>
              ))}
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              <div className="flex justify-between items-center mb-6">
                <div>
                  ...
                  <p className="text-gray-500">Showing {companies.length} results</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {companies.length === 0 ? (
                  <p className="text-gray-500 py-8 text-center col-span-2">No companies found</p>
                ) : (
                    ...
                    >
                      <div className="flex items-start gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-blue-600 text-sm">{company.jobCount} Jobs</p>
                        </div>
                      </div>
